...
import com.example.loginandforgetpassword.ExpandableListViewActivity;
...
public class ExpandableFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //适配器对象初始化
        MyExpandableListViewAdapter myExpandableListViewAdapter=new MyExpandableListViewAdapter(getContext(),grouplist, (HashMap<String, List<ExpandableBean>>) childData);
